  ...
  const handleSubmit = (e) => {
    ...
    if (formData.source === 'internal' && formData.driver) {
      ...
      if (driverObj && driverObj.email) {
        ...
        // Use the centralized email function with proper error handling
        (async () => {
          try {
            const emailResult = await sendDriverConfirmationEmail({
              ...
              subject,
              html
              // No need to pass JWT - function handles it internally
            });
            ...
            if (emailResult.success) {
              ...
              alert(`Failed to send confirmation email: ${emailResult.error}`);
            }
          } catch (error) {
